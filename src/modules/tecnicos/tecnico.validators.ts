...
export const createTecnicoSchema = z.object({
  ...
  id_gestor: z.number().int().positive(),
  ativo: z.boolean().optional()
});

// Schema para atualizar um técnico (todos os campos opcionais)
export const updateTecnicoSchema = z.object({
  ...
  id_gestor: z.number().int().positive().optional(),
  ativo: z.boolean().optional()
...
export const listTecnicosQuerySchema = z.object({
  ...
  id_gestor: z.coerce.number().int().positive().optional()
});
